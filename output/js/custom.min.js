...
function getImgAttribute(){var e=document.querySelector("#banner1"),t=document.querySelector("#banner1 img"),o=t.getAttribute("src");e.setAttribute("style","background-image:url('"+o+"')"),t.remove()}$(function(){"use strict";$(function(){$('[data-toggle="tooltip"]').tooltip()}),$(function(){$('[data-toggle="popover"]').popover()}),$("body").trigger("resize")}),$(function(){"use strict";$(function(){$('[data-toggle="tooltip"]').tooltip()}),$(function(){$('[data-toggle="popover"]').popover()}),$("body").trigger("resize")}),$(function(){"use strict";$(window).scroll(function(){250<=$(window).scrollTop()?($(".navbar-dark").addClass("nav-bg"),$(".fadeInUp").css("backgroundColor","#fff"),$(".nav-item a, .ti-menu").css("color","#000"),$(".btn-hire-me").css({color:"#000",borderColor:"#000"}),$(".nav-item a").mouseleave(function(){$(this).css("color","#000")}),$(".black-logo").show(),$(".white-logo").hide()):($(".navbar-dark").removeClass("nav-bg"),$(".fadeInUp").css("backgroundColor","#000"),$(".nav-item a, .ti-menu").css("color","#fff"),$(".btn-hire-me").css({color:"#fff",borderColor:"#fff"}),$(".black-logo").hide(),$(".white-logo").show())})}),$(function(){"use strict";$(window).scroll(function(){250<=$(window).scrollTop()?($(".nav-item a").mouseenter(function(){$(this).css("color","#188ef4")}),$(".nav-item a").mouseleave(function(){$(this).css("color","#000")})):($(".nav-item a").mouseenter(function(){$(this).css("color","red")}),$(".nav-item a").mouseleave(function(){$(this).css("color","#fff")}))})}),window.onload=function(){var l=document.querySelector(".second-hand"),i=document.querySelector(".min-hand"),a=document.querySelector(".hour-hand"),u=document.querySelector(".Seconds"),d=document.querySelector(".Minutes"),m=document.querySelector(".Hours");setInterval(function(){var e=new Date,t=e.getSeconds(),o=t/60*360+90;l.style.transform="rotate("+o+"deg)";var n=e.getMinutes(),r=n/60*360+90;i.style.transform="rotate("+r+"deg)";var c=e.getHours(),s=c/12*360+90;a.style.transform="rotate("+s+"deg)",u.textContent=t<10||0===t?"0"+t:t,d.textContent=n<10||0===n?"0"+n:n,m.textContent=c<10||0===c?"0"+c:c},1e3),document.querySelector(".animation").style.display="none";var e=document.querySelector(".static-slider-head"),t=document.getElementById("timeismany");document.body.contains(e)||(t.style.paddingTop="200px");var o=document.querySelectorAll(".slide"),n=document.getElementById("arrow-left"),r=document.getElementById("arrow-right"),c=document.querySelector(".wrap"),s=0;function f(){for(var e=0;e<o.length;e++)o[e].style.display="none";s++,console.log(s++),s>o.length&&(s=1),o[s-1].style.display="block",s--;var t=setTimeout(f,5e3);c.addEventListener("mouseover",function(){clearTimeout(t)}),n.addEventListener("click",function(){0===s&&(s=4,s--),function(){for(var e=0;e<o.length;e++)o[e].style.display="none";o[--s].style.display="block"}()}),r.addEventListener("click",function(){!function(){for(var e=0;e<o.length;e++)o[e].style.display="none";o[++s].style.display="block",console.log(s),s===o.length-1&&(s=-1)}()})}f(),c.addEventListener("mouseleave",function(){setTimeout(f,1500)})},getImgAttribute();
